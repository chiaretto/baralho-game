...
describe('compareCards', () => {
  ...
  it('should sort all cards', async() => {   
    const cards = ['2♦r', '3♦r', 'A♦r', '3♣b', '5♣b', '9♠r', '2♣r', '10♥b', 'A♣r'].map((c) => Card.parse(c));
    const wildCard = Card.parse('2♣r');
    ...
    // then
    const expected = ['2♦r', '3♦r', '9♠r', '10♥b', 'A♦r', '3♣b', '5♣b', 'A♣r', '2♣r'].map((c) => Card.parse(c));
...
describe('compareDeskItem', () => {
  ...
  it('should sort list desk items', async() => {
    const cards = ['A♦r', 'K♠b', 'Q♠b', 'J♠b', '10♠b', '9♠b', '8♠b', '7♠b', '6♠b', '5♠b', '4♠b', '3♠b', '2♠b',
      'A♠b', '3♠r', '9♠r', '10♠r', '2♠r', '5♦b', '8♦b', '10♦b', '2♣r', 'A♣r', '5♣r', '3♣r', '3♣b', 'J♣r',
      '2♥b', '2♥r', '3♥b', 'A♥b', 'J♥b', '5♥r', '9♥r', '10♥r'].map((c) => Card.parse(c));
    const expectedCards = [
      '2♥r', '2♥b', '2♠r', '2♠b', '3♥b', '3♠r', '3♠b', '4♠b', '5♥r', '5♦b', '5♠b', '6♠b', '7♠b', 
      '8♦b', '8♠b', '9♥r', '9♠r', '9♠b', '10♥r', '10♦b', '10♠r', '10♠b', 
      'J♥b', 'J♠b', 'Q♠b', 'K♠b', 'A♥b', 'A♠b', 'A♦r', 
      '3♣b', '3♣r', '5♣r', 'J♣r','A♣r','2♣r'
    ];
